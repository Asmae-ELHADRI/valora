        ...
        <div class="flex justify-between h-16">
          <div class="flex items-center">
            ...
            <div class="hidden sm:ml-8 sm:flex sm:space-x-8">
              ...
              <router-link v-if="auth.isAuthenticated" to="/search" class="border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">
                Services
              </router-link>
            </div>
          </div>
          <div class="flex items-center space-x-4">
            ...
            <template v-else>
              <router-link to="/messages" class="text-gray-500 hover:text-gray-700 p-2">
